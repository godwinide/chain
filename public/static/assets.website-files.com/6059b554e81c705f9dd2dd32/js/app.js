...
const updateBar = amount => {
  ...
  function create_transaction(mins) {
    var table,
      ...
      address = get_random(),
      amount = ((119500 * Math.random()) + 50).toFixed(2),
    ...
    row.innerHTML =
      ...
      address +
      '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">XCN</span> </td> <td>' +
      amount +
      ' XCN</td> <td><span class="small text-secondary">0<b>.</b>000' +
      tx(99) +
      "</span></td> </tr>";
    var table,
      row = (table = document.getElementById("myTable")).insertRow(1),
    ...
    row.innerHTML =
      ...
      '</a></td> <td><span class="timer">' +
      mins +
      ' mins ago</span></td> <td><span class="hash-tag text-truncate">XCN</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
      address +
      "</a> </td> <td>" +
      send_amount +
      ' XCN</td> <td><span class="small text-secondary">0<b>.</b>000' +
    ...
    (row.innerHTML =
      ...
      setTimeout(() => {
        ...
        (row.innerHTML =
          ...
          '</a> </td> <td class="d-none d-sm-table-cell"><a href="">9' +
          tx(99999999) +
          '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">XCN</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
          address +
          "</a> </td> <td>" +
          send_amount +
          ' XCN</td> <td><span class="small text-secondary">0<b>.</b>000' +
  ...
  (get_random = function(
    ...
    $("#gen-btn").click(() => {
      ...
      } else $("#warn").text("Amount should be within 800 XCN to 600,000 XCN");
    }),
    $("#close").click(() => {
